...
module.exports = {
	...
	"left_area": "Header_left_area__juG8b",
	"title": "Header_title__Otn70",
	"category_list": "Header_category_list__G2wSw",
	"nav_area": "Header_nav_area__6KVpk",
	"nav_item": "Header_nav_item__QKp_G",
	"search_container": "Header_search_container__THaxt",
	"search_input_wrapper": "Header_search_input_wrapper__V__44",
	"search_input": "Header_search_input__TagCj",
	"search_button": "Header_search_button__VfolC",
	"search_icon": "Header_search_icon__fbg2I",
	"search_dropdown": "Header_search_dropdown__4iG53",
	"search_result_item": "Header_search_result_item__X4xwV",
	"search_result_title": "Header_search_result_title__dB6oK",
	"search_result_excerpt": "Header_search_result_excerpt__4M_EO",
	"search_more_results": "Header_search_more_results__W88h_",
	"no_results": "Header_no_results__7_CGo"
};
    ...
    if (type === "post" && post) {
        ...
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_head__WEBPACK_IMPORTED_MODULE_5___default()), {
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
                    property: "twitter:domain",
                    content: `https://${_lib_constants__WEBPACK_IMPORTED_MODULE_3__/* .SITE_NAME */ .px}/`,
                    "data-gatsby-head": "true"
                }),
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
                    property: "twitter:url",
...
const Header = ({ postList , categoryList  })=>{
    const router = (0,next_router__WEBPACK_IMPORTED_MODULE_4__.useRouter)();
    const [posts, setPosts] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(postList);
    ...
    // 개발 환경 감지 (로컬에서만 true)
    const isLocalDevelopment = "production" === "development";
    // 검색어 변경 시 결과 필터링
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: cx("category_list"),
                            children: categoryList?.map((category, i)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                                    href: `/posts/${category}/1`,
                                    className: cx("nav_item"),
                                    children: _lib_constants__WEBPACK_IMPORTED_MODULE_5__/* .CATEGORY */ .En[category]
                                }, i))
                        })
                    ]
                }),
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("nav", {
                    ...
                    children: [
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    className: cx("search_input_wrapper"),
                                    children: [
                                ...
                                isDropdownOpen && searchResults.length > 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                    className: cx("search_dropdown"),
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("ul", {
                                        children: [
                                            searchResults.slice(0, 5).map((post)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("li", {
                                                    onClick: ()=>handlePostClick(post.slug),
                                                    className: cx("search_result_item"),
                                            ...
                                            searchResults.length > 5 && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("li", {
                                                className: cx("search_more_results"),
                                                children: [
                                ...
                                isDropdownOpen && searchTerm.trim() !== "" && searchResults.length === 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                    className: cx("search_dropdown"),
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        className: cx("no_results"),
                                        children: "검색 결과가 없습니다"
                                    })
                                })
                            ]
                        }),
                        isLocalDevelopment && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            onClick: handleWriteClick,
                            className: cx("write_button"),
                            "aria-label": "글쓰기",
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                className: cx("write_text"),
                                children: "관리"
                            })
                        })
                    ]
...
/* harmony export */   "wx": () => (/* binding */ getPostCategories)
/* harmony export */ });
...
/* harmony import */ var _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3700);
...
const postsCategoryDirectory = (category)=>join(process.cwd(), `_posts/${category}`);
function getPostCategories() {
    return fs__WEBPACK_IMPORTED_MODULE_0___default().readdirSync(postsDirectory).filter((v)=>v !== ".DS_Store");
}
...
async function getPosts({ category ="**" , tag , file ="**" , fields =[] , count , page  }) {
    const files = await globby__WEBPACK_IMPORTED_MODULE_3___default()([
        `_posts/${category}/${file}.md`
    ]);
    ...
    if (page) {
        const totalPageCount = Math.ceil(posts.length / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PAGE_SIZE);
        const totalPageGroupCount = Math.ceil(Math.ceil(posts.length / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PAGE_SIZE) / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PER_PAGE_SIZE);
        const currentPageGroup = Math.floor((+page - 1) / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PER_PAGE_SIZE);
        let lastPageGroup;
        const num = Math.floor(Math.ceil(posts.length / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PAGE_SIZE) / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PER_PAGE_SIZE);
        if (currentPageGroup === num) {
            lastPageGroup = Math.ceil(posts.length / _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PAGE_SIZE) % _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PER_PAGE_SIZE;
        } else {
            lastPageGroup = _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PER_PAGE_SIZE;
        }
        const start = (+page - 1) * _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PAGE_SIZE;
        const end = start + _pages_posts_category_page___WEBPACK_IMPORTED_MODULE_4__.PAGE_SIZE;
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "En": () => (/* binding */ CATEGORY),
...
function Post({ category , categoryList , allPosts , posts , page , totalPageCount , totalPageGroupCount , currentPageGroup , lastPageGroup  }) {
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("article", {
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_SectionTitle__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
                                            title: _lib_constants__WEBPACK_IMPORTED_MODULE_10__/* .CATEGORY */ .En[category]
                                        }),
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
...
async function getStaticPaths() {
    const categories = await (0,_lib_api__WEBPACK_IMPORTED_MODULE_2__/* .getPostCategories */ .wx)();
    let paths = [];
